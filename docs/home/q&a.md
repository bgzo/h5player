...
To simplify the process, the author has released [ffmpeg-script](https://github.com/bgzo/ffmpeg-script), which can achieve:
...
For detailed instructions, see: [https://github.com/bgzo/ffmpeg-script](https://github.com/bgzo/ffmpeg-script)
